...
const TodoGUIId = {
    ...
    ITEM_CARD_MOVEUP: 'moveup',
    ITEM_CARD_MOVEDOWN: 'movedown',
    ITEM_CARD_DELETE: 'delete',
    MODAL_YES_NO_DIALOG: 'modal_yes_no_dialog',
    YES_DELETE: 'yes_delete',
    NO_DELETE: 'no_delete',
    LIST_ADD_ITEM: 'list_add_item',
    CANCEL_NEW_ITEM: 'cancel_new_item',
...
const TodoCallback = {
    ...
    PROCESS_ITEM_SCREEN: "processItemScreen",
    PROCESS_SUBMIT_ADD_ITEM: "processSubmitAddItem",
    ...
    PROCESS_DO_NOTHING: "window.todo.controller.processDoNothing",
};
